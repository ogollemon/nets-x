...
class phpFlickr {
    ...
    function request ($command, $args = array(), $nocache = false)
    {
		...
		// For PHP5, wrap args as an array if it isn't.
		if (!is_array($args)) 
		{
			$args = array($args);
		}
    ...
    */
	...
	// Aral: user_id is actually required. Made it so.
    function favorites_getPublicList($user_id, $extras = NULL, $per_page = NULL, $page = NULL)
    {
