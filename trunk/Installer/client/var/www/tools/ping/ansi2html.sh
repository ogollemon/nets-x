...
P="\(^[^Â°]*\)Â¡$p" #expression to match prepended codes below
...
:e
s#${p}\([0-9;]\{1,\}\);\([34]8;5;[0-9]\{1,3\}\)m#${p}\1m${p}Â¬\2m#g; t e
s#${p}\([34]8;5;[0-9]\{1,3\}\)m#${p}Â¬\1m#g;
...
s#Â°#\&deg;#g; s#${p}0m#Â°#g
s#Â¡#\&iexcl;#g; s#${p}[0-9;]*m#Â¡&#g
" |
...
/^[^Â¡]*Â°/ { b span_end } # replace 'reset code' if no preceeding code

# common combinations to minimise html (optional)
s#${P}3\([0-7]\)mÂ¡${p}4\([0-7]\)m#\1<span class=\"f\2 b\3\">#;t span_count
s#${P}4\([0-7]\)mÂ¡${p}3\([0-7]\)m#\1<span class=\"f\3 b\2\">#;t span_count
