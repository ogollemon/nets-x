...
//                         print '</p>';
    ...
    <!-- BEGIN CONTENT AREA -->
    <div id="contentLayer">
        <div id="flashLayer" class="container">
            <?php print $content_for_layout; ?>
        </div>
        <div id="pda" style="display:none;">
            <?php print $this->element('pda_menu', array('exitAction'=>'toggleLayers')); ?>
            <?php print $this->element('pda_loading', array('id'=>'loading_pda')); ?>
            <div id="pda_screen" style="display:block;"></div>
        </div>
    </div>
    <!-- END CONTENT AREA -->
    ...
    <!-- BEGIN FOOTER AREA -->
    <div id="footer">
        <div id="footerLogo"><?php e($html->image('footer-logo.png', array('width'=>211, 'height'=>45))); ?></div>
    </div>
    <!-- END FOOTER AREA -->
