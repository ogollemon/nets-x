<?php
    ...
    class HtmlReporter extends SimpleReporter {
        ...
        function paintFooter($test_name) 
		{
			...
			$hasErrors = ($failCount + $exceptionCount) > 0;
			
			$testCaseCount = $this->getTestCaseCount();
	
			$colour = $hasErrors ? "red" : "green";
			
            print "<div style=\"";
            print "padding: 1px; padding-left: 14px; background-color: $colour; color: white;";
            print "\"><font size='-1'>";

			if ($hasErrors)
			{
				print "<strong>SWX PHP Assembler Error! </strong>";

	            print $this->getTestCaseProgress() . " of " . $testCaseCount;
	            print ' test case'.($testCaseCount > 1 ? 's':'')." complete:\n";
			...
			{
				print "SWX PHP Assembler is working correctly.";
			}
	...
	class SwxReporter extends HtmlReporter
	{
